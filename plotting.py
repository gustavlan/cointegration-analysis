...
def plot_systematic_performance(*args, **kwargs):
    ...
    from backtests import compute_rolling_beta as _rolling_beta, compute_rolling_sharpe as _rolling_sharpe
    ...
    # Generate using original helper
    plot_df = plot_systematic_performance_original(
        systematic_results, selected_pairs, benchmark_returns, _rolling_sharpe, _rolling_beta, title="Systematic Strategy Performance"
    )
